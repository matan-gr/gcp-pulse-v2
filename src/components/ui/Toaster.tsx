...
export const Toaster = () => {
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "group flex items-center w-full bg-white dark:bg-slate-800 text-[#202124] dark:text-slate-100 border border-[#dadce0] dark:border-slate-700 shadow-lg rounded-xl p-4 font-sans",
          title: "text-sm font-medium",
          description: "text-sm text-[#5f6368] dark:text-slate-300",
          actionButton: "bg-[#1a73e8] text-white rounded-lg px-3 py-1.5 text-sm font-medium hover:bg-[#1557b0] transition-colors",
          cancelButton: "bg-transparent text-[#5f6368] dark:text-slate-300 hover:bg-[#f1f3f4] dark:hover:bg-slate-700 rounded-lg px-3 py-1.5 text-sm font-medium transition-colors",
          ...
          info: "group-[.toaster]:bg-[#e8f0fe] dark:group-[.toaster]:bg-blue-500/20 group-[.toaster]:text-[#1967d2] dark:group-[.toaster]:text-blue-400 group-[.toaster]:border-[#d2e3fc] dark:group-[.toaster]:border-blue-500/30",
      ...
      icons={{
        ...
        info: <Info className="w-5 h-5 text-[#1967d2] dark:text-blue-400" />,
