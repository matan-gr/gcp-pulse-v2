...
export const ErrorDisplay: React.FC<ErrorDisplayProps> = ({ title = "Oops! Something went wrong", message, onRetry }) => {
  return (
    <motion.div 
    ...
    >
      ...
      <p className="text-gray-600 dark:text-slate-300 max-w-md mb-8">{message}</p>
      <button
        onClick={onRetry}
